...
void transformMatrix(Matrix m, float x, float y, float z, float w, float &ix, float &iy, float &iz,
					 float &iw)
{
...
void cross(float ax, float ay, float az, float bx, float by, float bz, float &cx, float &cy,
		   float &cz)
{
	cx = bz * ay - by * az;
	cy = bx * az - bz * ax;
