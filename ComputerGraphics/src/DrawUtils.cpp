...
void cube(double x, double y, double z, double e) {
  ...
  double s = e / 2;
  polygon(4, x - s, y - s, z - s, x + s, y - s, z - s, x + s, y + s, z - s,
          x - s, y + s, z - s);
  polygon(-4, x - s, y - s, z + s, x + s, y - s, z + s, x + s, y + s, z + s,
          x - s, y + s, z + s);
...
void cube2(double x, double y, double z, double e, double e1, double e2) {
  ...
  polygon(4, x - s, y - s1, z - s2, x + s, y - s1, z - s2, x + s, y + s1,
          z - s2, x - s, y + s1, z - s2);
  polygon(-4, x - s, y - s1, z + s2, x + s, y - s1, z + s2, x + s, y + s1,
          z + s2, x - s, y + s1, z + s2);
...
//////////////////////////////////////////////////////////////
void lookatMatrix(float ex, float ey, float ez, float ax, float ay, float az,
                  Matrix r) {
  glPushMatrix();
  glLoadIdentity();
